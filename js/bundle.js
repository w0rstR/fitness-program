...
function cards() {
  ...
  (0,_services_services__WEBPACK_IMPORTED_MODULE_0__.getResource)('http://localhost:3000/menu').then(data => createCard(data)); // axios.get('http://localhost:3000/menu')
...
/* harmony default export */ __webpack_exports__["default"] = (cards); // new MenuCard(
//     "img/tabs/elite.jpg",
//     'elite',
//     'Меню “Премиум”',
...
function form(formSelector, modalTimerId) {
  ...
  function bindPostData(form) {
    ...
    form.addEventListener('submit', event => {
      ...
      statusMessage.style.cssText = "display:block; margin:0 auto;";
      form.insertAdjacentElement('afterend', statusMessage);
      const formData = new FormData(form); // Convert FormData to JSON
      // const object={}
      // formData.forEach(function(value,key){
      //     object[key]=value
      // })
...
function modal(triggerSelector, modalSelector, modalTimerId) {
  ...
  const modalWindow = document.querySelector(modalSelector); //const modalCloseBtn=document.querySelector('[data-close]')
...
function slider({
  ...
  let offset = 0;
  const slider = document.querySelector(container); //THE SECOND OPTION
  // showSlides()
  // if(slides.length<10){
...
window.addEventListener('DOMContentLoaded', () => {
  const modalTimerId = setTimeout(() => (0,_modules_modal__WEBPACK_IMPORTED_MODULE_1__.showModalWindow)('.modal', modalTimerId), 600000); // const tabs = require('./modules/tabls')
